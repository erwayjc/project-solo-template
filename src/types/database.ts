...
export type FunnelInsert = Tables['funnels']['Insert']
export type FunnelUpdate = Tables['funnels']['Update']
export type FunnelStep = Tables['funnel_steps']['Row']
export type FunnelStepInsert = Tables['funnel_steps']['Insert']
export type FunnelEvent = Tables['funnel_events']['Row']
export type FunnelEventInsert = Tables['funnel_events']['Insert']
export type AgentSchedule = Tables['agent_schedules']['Row']
export type AgentScheduleInsert = Tables['agent_schedules']['Insert']
export type AgentScheduleUpdate = Tables['agent_schedules']['Update']
export type AgentTrigger = Tables['agent_triggers']['Row']
export type AgentTriggerInsert = Tables['agent_triggers']['Insert']
export type AgentTriggerUpdate = Tables['agent_triggers']['Update']
...
export type AgentStatus = Tables['agent_status']['Row']
export type AgentStatusInsert = Tables['agent_status']['Insert']
export type AgentStatusUpdate = Tables['agent_status']['Update']
